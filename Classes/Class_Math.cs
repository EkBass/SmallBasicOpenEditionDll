...
namespace SmallBasicOpenEditionDll
{
    ...
    public static class Math
    {
        ...
        public static dynamic Pi => System.Math.PI;
        ...
        public static dynamic Abs(dynamic number) => System.Math.Abs(number);
        ...
        public static dynamic Ceiling(dynamic number) => System.Math.Ceiling(number);
        ...
        public static dynamic Floor(dynamic number) => System.Math.Floor(number);
        ...
        public static dynamic NaturalLog(dynamic number) => System.Math.Log(number);
        ...
        public static dynamic Log(dynamic number) => System.Math.Log10(number);
        ...
        public static dynamic ArcSin(dynamic sinValue) => System.Math.Asin(sinValue);
        ...
        public static dynamic ArcCos(dynamic cosValue) => System.Math.Acos(cosValue);
        ...
        public static dynamic ArcTan(dynamic tanValue) => System.Math.Atan(tanValue);

        /// <summary>Converts the specified angle from radians to degrees.</summary>
        /// <param name="angle">An angle in radians.</param>
        /// <returns>The equivalent angle in degrees.</returns>
        public static dynamic GetDegrees(dynamic angle) => angle * (180 / System.Math.PI);
        ...
        public static dynamic GetRadians(dynamic angle) => angle * (System.Math.PI / 180);
        ...
        public static dynamic SquareRoot(dynamic number) => System.Math.Sqrt(number);
        ...
        public static dynamic Power(dynamic baseNumber, dynamic exponent) => System.Math.Pow(baseNumber, exponent);
        ...
        public static dynamic Round(dynamic number) => System.Math.Round(number);
        ...
        public static dynamic Max(dynamic number1, dynamic number2) => System.Math.Max(number1, number2);

        /// <summary>Returns the smaller of two numbers.</summary>
        /// <param name="number1">The first number to compare.</param>
        /// <param name="number2">The second number to compare.</param>
        /// <returns>The smaller of the two numbers.</returns>
        public static dynamic Min(dynamic number1, dynamic number2) => System.Math.Min(number1, number2);
        ...
        public static dynamic Remainder(dynamic dividend, dynamic divisor) => dividend % divisor;
        ...
        public static dynamic GetRandomNumber(dynamic maxNumber)
        {
            Random random = new();
        ...
        public static dynamic DoubleToDecimal(dynamic number) => Convert.ToDecimal(value: (double)number);
    }
}
